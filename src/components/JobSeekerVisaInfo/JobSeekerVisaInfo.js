  ...
  const stepsData = [
    {
      ...
      description: "Send us your basic details and documents to start your job seeker journey.",
    },
    {
      icon: <FaSearchLocation />,
      title: "Country Match & Review",
      description: "Our visa experts will evaluate your profile and suggest the best country options.",
    },
    {
      icon: <FaHandsHelping />,
      title: "Job Search & Support",
      description: "Get help with resume building, job search strategy, and expert guidance.",
    },
    {
      icon: <FaPlaneDeparture />,
      title: "Visa Filing & Relocation",
      description: "We assist with documentation, visa application, and relocation planning.",
    },
  ];
  ...
  return (
    <section className="visa-info">
      ...
      <div className="visa-info__section visa-info__countries">
        <div className="visa-info__header">
          <h2 className="visa-info__title">Top Countries Offering Job Seeker Visas</h2>
        ...
        <div className="visa-info__country-grid">
          {countriesToShow.length > 0 ? (
            countriesToShow.map((country, index) => (
              <div className="visa-info__country-item" key={index}>
                <img
                  loading="lazy"
                ...
                <p className="visa-info__country-description">{country.description}</p>
              </div>
            ))
          ) : (
            <p className="visa-info__no-results">No matching country found.</p>
          )}
        </div>

        {!searchTerm && jobSeekerCountries.length > 12 && (
          <div style={{ textAlign: "center", marginTop: "30px" }}>
            <button className="visa-info__cta-button"
      ...
      <div className="visa-info__section visa-info__eligibility">
        ...
        <div className="visa-info__eligibility-grid">
          {eligibility.map((item, index) => (
            <div className="visa-info__eligibility-item" key={index}>
