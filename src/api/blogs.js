...
const blogs = [
  {
    ...
    tags: ['Immigration', 'Abroad', 'Family'],
  },
  {
    id: '2',
    ...
    blClass: 'format-standard-image',
    style: 'color-2',
    tags: ['Visa', 'Visa Process', 'Immigration'],
  },
  {
    id: '3',
    ...
    create_at: '22 August 2025',
    comment: '95',
    thumb: 'Consulting',
    blClass: 'format-video',
    style: 'color-3',
    tags: ['Student', 'Abroad', 'Visa'],
  },
  {
    id: '4',
    ...
    author: 'Aliza Anny',
    authorTitle: 'Art Director',
    create_at: '15 October 2025',
    comment: '95',
    thumb: 'Consulting',
    tags: ['Portfolio', 'Design', 'Creativity'],
  },
